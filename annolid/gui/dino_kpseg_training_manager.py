...
class DinoKPSEGTrainingManager(QtCore.QObject):
    ...
    def start_training(
        ...
        *,
        ...
        radius_px: float = dino_defaults.RADIUS_PX,
        ...
        lr: float = dino_defaults.LR,
        epochs: int = dino_defaults.EPOCHS,
        ...
        radius_start_px: float = dino_defaults.RADIUS_START_PX,
        radius_end_px: float = dino_defaults.RADIUS_END_PX,
        overfit_n: int = 0,
        device: Optional[str],
        cache_features: bool,
        ...
        early_stop_metric: str = dino_defaults.EARLY_STOP_METRIC,
        pck_weighted_weights: str = dino_defaults.PCK_WEIGHTED_WEIGHTS,
        augment: bool = dino_defaults.AUGMENT_ENABLED,
        hflip: float = dino_defaults.HFLIP,
        degrees: float = dino_defaults.DEGREES,
        translate: float = dino_defaults.TRANSLATE,
        scale: float = dino_defaults.SCALE,
        brightness: float = dino_defaults.BRIGHTNESS,
        contrast: float = dino_defaults.CONTRAST,
        saturation: float = dino_defaults.SATURATION,
        ...
        def train_task(*, stop_event=None):
            ...
            cmd: list[str] = [
                ...
                str(float(radius_px)),
                "--mask-type",
                str(mask_type or dino_defaults.MASK_TYPE),
                "--instance-mode",
                str(instance_mode or dino_defaults.INSTANCE_MODE),
                "--bbox-scale",
                ...
                str(float(threshold)),
                "--bce-type",
                str(bce_type or dino_defaults.BCE_TYPE),
                "--focal-alpha",
                ...
                "--radius-schedule",
                str(radius_schedule or dino_defaults.RADIUS_SCHEDULE),
                "--radius-start-px",
                ...
                "--best-metric",
                str(best_metric or dino_defaults.BEST_METRIC),
                "--early-stop-metric",
                str(early_stop_metric or dino_defaults.EARLY_STOP_METRIC),
                "--pck-weighted-weights",
                str(pck_weighted_weights or dino_defaults.PCK_WEIGHTED_WEIGHTS),
            ]
            ...
            if bool(tb_projector):
                ...
                cmd += [
                    "--tb-projector-split",
                    str(tb_projector_split or dino_defaults.TB_PROJECTOR_SPLIT),
                ]
