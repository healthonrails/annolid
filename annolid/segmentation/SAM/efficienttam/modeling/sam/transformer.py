...
from annolid.segmentation.SAM.efficienttam.modeling.efficienttam_utils import MLP

from annolid.segmentation.SAM.efficienttam.modeling.position_encoding import (
    apply_rotary_enc,
    compute_axial_cis,
)
    ...
    def forward(
        ...
        if self.rope_k_repeat:
            ...
            if num_k_rope <= nq:
                ...
                k_landmarks = k_landmarks.transpose(
                    -2, -1).reshape(fs, -1, intw, inth)
                ...
                v_landmarks = v_landmarks.transpose(
                    -2, -1).reshape(fs, -1, intw, inth)
