...
from annolid.segmentation.SAM.efficienttam.modeling.efficienttam_base import (
    EfficientTAMBase,
    NO_OBJ_SCORE,
)
from annolid.segmentation.SAM.efficienttam.utils.misc import (
    concat_points,
...
class EfficientTAMVideoPredictor(EfficientTAMBase):
    ...
    def from_pretrained(cls, model_id: str, **kwargs) -> "EfficientTAMVideoPredictor":
        ...
        """
        from annolid.segmentation.SAM.efficienttam.build_efficienttam import (
            build_efficienttam_video_predictor_hf,
        )

        tam_model = build_efficienttam_video_predictor_hf(model_id, **kwargs)
