...
def agent_inference(
    ...
    """
    # setup dir
    temp_output_ctx = None
    if output_dir in (None, ""):
        temp_output_ctx = tempfile.TemporaryDirectory(prefix="sam3_agent_out_")
        output_dir = temp_output_ctx.name
    try:
        ...
        if temp_output_ctx is not None:
            temp_output_ctx.cleanup()
