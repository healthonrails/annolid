...
class Sam3VideoInference(Sam3VideoBase):
    ...
    def _postprocess_output(
        ...
        if len(curr_obj_ids) == 0:
            ...
            keep_idx_for_tracker = (
                keep_idx.to(out_tracker_probs.device, non_blocking=True)
                if keep_idx.device != out_tracker_probs.device
                else keep_idx
            )
            ...
            out_tracker_probs = torch.index_select(
                out_tracker_probs, 0, keep_idx_for_tracker
            )
