...
- **Heuristic defaults aligned with upstream**: hotstart defaults now follow upstream (`0/0/0`) and can be overridden with `ANNOLID_SAM3_HOTSTART_DELAY`, `ANNOLID_SAM3_HOTSTART_UNMATCH_THRESH`, and `ANNOLID_SAM3_HOTSTART_DUP_THRESH`.
